package net.ducatillon.javasandbox.datatypes.equality;
...
public class PlayingWithEquality {
  ...
  public static void case05() {
    ...
    if (float3 == float4) {
      System.out.println("float3 == float4");
    }
  }
  ...
  public static void floatPrecision() {
    ...
    float positiveValue = 123.1234567891f;
    float negativeValue = -123.1234567891f;
